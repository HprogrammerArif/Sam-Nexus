...
const Shop = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const { data } = await axiosSecure(
        `/all-shop-products?page=${currentPage}&size=${itemsPerPage}&filter=${filter}&sort=${sort}&search=${search}`
      );
      return data;
    },
  });
  ...
  useEffect(() => {
    const getCount = async () => {
      const { data } = await axiosSecure(
        `/all-shop-products-count?filter=${filter}&search=${search}`
      );
  ...
  return (
    <Container>
      ...
      <ProductIntro
        ...
        description={
          "Our All Top Metarial is your gateway to extraordinary culinary experiences. We believe that you deserve nothing but the best"
        }
      ></ProductIntro>
